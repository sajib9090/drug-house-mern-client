                  ...
                  {user && user ? (
                    ...
                    <>
                      <li title="Login/SignIn">
                        <Link
                          to="/login"
                          className="hover:text-sh flex items-center text-base font-medium"
                        >
                          Login/Sign In
        ...
        <div className="navbar-end w-[80%] hidden lg:flex">
          <ul className="menu menu-horizontal space-x-6">
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "text-sh font-medium text-base dark:text-gray-500 scale-110"
                  : "font-medium text-base dark:text-white hover:text-sh hover:dark:text-gray-500 duration-700 hover:scale-110"
              }
            >
              <li>Home</li>
            </NavLink>
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "text-sh font-medium text-base dark:text-gray-500 scale-110"
                  : "font-medium text-base dark:text-white hover:text-sh duration-700 hover:dark:text-gray-500 hover:scale-110"
              }
            >
              <li>Blog</li>
            </NavLink>
